// KyMonBanHaDo.js - Hà Đồ Kỳ Môn Độn Giáp Engine (ĐÃ FIX LỖI THIẾU HÀM)
...
(function (root, factory) {
  ...
  function tinhThienBanVaCan(db, cungGoc, canGio, canTuanThu) {
    ...
    if (cungDich === 5) cungDich = 2; // Trung Cung ký tại Khôn
  ...
  // ============================================================
  // 5. CÁC HÀM LOGIC PHONG THỦY BỔ TRỢ (ĐẦY ĐỦ NHƯ BẢN GỐC)
  // ============================================================
  ...
  function lapBanKyMon(dateStr, options = {}) {
    ...
    const TIET_KHI_SOC_CUC = {
      'Đông Chí':{type:'duong',soCuc:1},'Tiểu Hàn':{type:'am',soCuc:9},'Đại Hàn':{type:'am',soCuc:6},'Lập Xuân':{type:'am',soCuc:3},'Vũ Thủy':{type:'am',soCuc:7},'Kinh Trập':{type:'am',soCuc:1},'Xuân Phân':{type:'duong',soCuc:3},'Thanh Minh':{type:'duong',soCuc:6},'Cốc Vũ':{type:'duong',soCuc:9},'Lập Hạ':{type:'duong',soCuc:2},'Tiểu Mãn':{type:'duong',soCuc:5},'Mang Chủng':{type:'duong',soCuc:8},'Hạ Chí':{type:'am',soCuc:9},'Tiểu Thử':{type:'am',soCuc:3},'Đại Thử':{type:'am',soCuc:6},'Lập Thu':{type:'am',soCuc:9},'Xử Thử':{type:'am',soCuc:6},'Bạch Lộ':{type:'am',soCuc:3},'Thu Phân':{type:'duong',soCuc:7},'Hàn Lộ':{type:'duong',soCuc:1},'Sương Giáng':{type:'duong',soCuc:4},'Lập Đông':{type:'duong',soCuc:7},'Tiểu Tuyết':{type:'duong',soCuc:1},'Đại Tuyết':{type:'duong',soCuc:4}
    };
    ...
    for (let c = 1; c <= 9; c++) {
      ...
      palaces.push({
        ...
        trangThai: {
          sao: starInfo.sao ? tinhTrangThai(hanhSao, mua, isTuQuyThang) : '',
          mon: batMon[c] ? tinhTrangThai(hanhMon, mua, isTuQuyThang) : ''
        },
